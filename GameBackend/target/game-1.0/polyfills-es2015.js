 ...
 *
 * ```ts
 * $localize `Hi game! There are ${items.length} items.`;
 * ```
 *
...
module.exports = __webpack_require__(/*! C:\Users\Notebook\Downloads\UK\TIA\Project\Frontend\src\polyfills.ts */"./src/polyfills.ts");
